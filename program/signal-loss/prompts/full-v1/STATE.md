...
| 05 | Fair Tiered AI, Workers, and Engine Facade | M11, M12, M15, M22 | `./src/engine/ai/**`<br>`./src/engine/index.ts`<br>`./src/workers/**`<br>`./tests/engine/ai/**`<br>`./tests/engine/facade/**`<br>`./tests/workers/**`<br>`./tests/fixtures/ai/**` | in-progress | — | — | |
