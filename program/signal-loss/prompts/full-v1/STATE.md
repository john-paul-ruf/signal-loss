...
| 07 | Build Zone, Setup, Codex, and Result Surfaces | M02, M07, M14, M17, M19, M20, M22 | `./src/app/bridge/mapgen-client.ts`<br>`./src/app/store/build/**`<br>`./src/app/components/build/**`<br>`./src/app/components/setup/**`<br>`./src/app/components/result/**`<br>`./src/app/screens/boot/**`<br>`./src/app/screens/build/**`<br>`./src/app/screens/codex/**`<br>`./src/app/screens/setup/**`<br>`./src/app/screens/result/**`<br>`./tests/app/build/**`<br>`./tests/e2e/build/**` | in-progress | — | — | |
